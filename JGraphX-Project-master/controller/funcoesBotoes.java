...
public class funcoesBotoes extends mxTraversal {
	...
	public static void gerarGrafoAleatorio(mxGraph graph) {
	    ...
	    deletarTodasCelulas(graph);
	    
	    // Adicionando v�rtices com coordenadas aleat�rias.
	    for(int i = 0 ; i < numeroVertices ; i++){
	    	int x = gerador.nextInt(406);
	    	int y = gerador.nextInt(406);
	    	adicionarVertice(graph, x, y);
	    }
